...
namespace SpaceRTSKit.UI
{
	...
	/// </summary>
	public class RTSSelectionBoxUI : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
	{
		/// <summary>
		...
		{
			if (selectionInput)
				selectionInput.useCustomClickInput = true;
		}
		/// <summary>
		...
		public void OnBeginDrag(PointerEventData eventData)
		{
			...
			{
				if (selectionInput && selectionInput.selectionBoxAllowed)
				{
					if(selectionBox)
