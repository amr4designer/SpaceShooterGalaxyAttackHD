...
namespace SpaceRTSKit.UI
{
	...
	public class UIProgressBar : MonoBehaviour
	{
		...
		{
			float width = background.rectTransform.rect.width * fillAmount;
			filler.rectTransform.SetSizeWithCurrentAnchors(RectTransform.Axis.Horizontal, width);
			//size.x = background.rectTransform.rect.width * fillAmount;
